...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is to inform you that a document has been rejected.</p>
            ...
            <div class="message">
                <p><strong>The document "{{ $documentTitle }}" has been rejected.</strong></p>
                @if($rejectorName)
                <p>Rejected by: <strong>{{ $rejectorName }}</strong></p>
                @endif
                @if($reason)
