...
<head>
    ...
    <title>Complete - Owner - Document Tracking System</title>
...
<body>
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-menu">
                        ...
                        <button class="nav-btn active" data-page="complete" onclick="navigateTo('complete')"><i class="bi bi-check-circle" style="font-size: 18px;"></i><span>Complete</span></button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-outline-secondary me-1" onclick="archiveDocument({{ $doc->id }}, '{{ addslashes($doc->title) }}')" title="Archive"><i class="bi bi-archive"></i></button>
                                    <button class="btn btn-sm btn-outline-danger" onclick="deleteDocument({{ $doc->id }}, '{{ addslashes($doc->title) }}')" title="Delete"><i class="bi bi-trash"></i></button>
                                </td>
                            </tr>
                            @empty
    ...
    <script>
            ...
            try {
                ...
                contentDiv.innerHTML = `
                    ...
                    <div class="details-section">
                        <h5 class="mb-3"><i class="bi bi-info-circle"></i> Document Details</h5>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <span class="badge bg-primary">${doc.current_status || '—'}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2 p-3 bg-light border-start border-primary border-4 rounded">
                    ...
                    ${doc.has_file ? `
                    <div class="file-info-box p-4 bg-info bg-opacity-10 border border-info rounded mt-4">
                        ...
                        <div class="text-center mt-4">
                            <p class="text-muted mb-2">Download the file to your device to view its contents</p>
                        </div>
                    </div>
                    ` : '<div class="alert alert-warning mt-4"><i class="bi bi-exclamation-triangle"></i> No file attached to this document.</div>'}
                `;
        ...
        async function archiveDocument(docId, docTitle) {
            showConfirmationModal(
                'Archive Document',
                `Archive document "${docTitle}"? It will be moved to archived documents.`,
                async () => {
                    try {
                        const response = await fetch(`/documents/${docId}/archive`, {
                            method: 'POST',
                            headers: {
                        ...
                        if (response.ok) {
                            ...
                            showToast(data.message || 'Failed to archive document', 'error');
                        }
                    } catch (error) {
                        console.error(error);
                        showToast('An error occurred while archiving the document', 'error');
                    }
                },
                'Archive',
                'btn-secondary'
        ...
        async function deleteDocument(docId, docTitle) {
            showConfirmationModal(
                'Delete Document',
                `Delete document "${docTitle}"? This action cannot be undone.`,
                async () => {
                    try {
