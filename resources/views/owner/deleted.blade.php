...
<head>
    ...
    <title>Deleted Documents - Owner - Document Tracking System</title>
    ...
    <div class="dashboard-container">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-menu">
                        ...
                        <button class="nav-btn active" data-page="deleted" onclick="navigateTo('deleted')"><i class="bi bi-trash" style="font-size: 18px;"></i><span>Deleted</span></button>
                    </div>
                </div>
            </div>
        ...
        <div class="main-content">
            ...
            <div class="content-body">
                <h1 class="page-title">DELETED DOCUMENTS</h1>
                <div class="alert alert-warning">
                    <i class="bi bi-exclamation-triangle me-2"></i>
                    These documents were permanently deleted. Information is retrieved from audit logs only.
                </div>
                    ...
                    <table class="documents-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-danger">{{ $doc->deleted_by }}</span>
                                </td>
                                <td>{{ $doc->deleted_at->format('Y-m-d H:i:s') }}</td>
                                <td>{{ $doc->description }}</td>
                            </tr>
                            @empty
                            <tr><td colspan="5" class="text-center">No deleted documents found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
