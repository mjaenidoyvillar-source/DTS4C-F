                    ...
                    <table class="documents-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($doc->file_data || $doc->id)<a href="#" class="view-document-link" data-document-id="{{ $doc->id }}" data-bs-toggle="modal" data-bs-target="#documentDetailsModal">View</a>@else — @endif</td>
