...
<head>
    ...
    <title>Outgoing - Handler - Document Tracking System</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-menu">
                        <button class="nav-btn active" data-page="outgoing" onclick="navigateTo('outgoing')"><i class="bi bi-send" style="font-size: 18px;"></i><span>Outgoing</span></button>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                ...
                <div class="documents-table-container">
                    <table class="documents-table">
                        <thead>
                            <tr>
                                <th>Route ID</th><th>Document</th><th>To Department</th><th>Target Owner</th><th>Status</th><th>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ optional($route->toDepartment)->name ?? '—' }}</td>
                                <td>{{ optional($route->targetOwner)->name ?? optional($route->targetOwner)->email ?? 'Not specified' }}</td>
                                <td>{{ $route->new_status ?? 'Sent' }}</td>
                                <td>
                                    <button class="btn btn-sm btn-outline-info" onclick="viewDocumentModal({{ $route->document_id }})" title="View Document"><i class="bi bi-eye"></i></button>
                                </td>
                            </tr>
                            @empty
                            <tr><td colspan="6" class="text-center">No outgoing documents</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
